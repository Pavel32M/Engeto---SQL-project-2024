...
WITH branch_salary_year AS
	(
		...
		ORDER BY payroll_year, industry_branch_code, payroll_quarter
	)
SELECT
	payroll_year,
	industry_branch_code,
...
WITH each_grocery_price_year AS
	(
		...
		ORDER BY year_from, region_code, category_code
	)
SELECT
	year_from,
	category_code,
...
SELECT * FROM t_Pavel_Mokrejs_project_SQL_primary_final_new;

...
SELECT * FROM total_salary_in_year_new;

SELECT * FROM total_price_in_year_new;

SELECT * FROM cz_gdp_year_new;

SELECT * FROM each_year_price_salary_GDP_CZ;
...
nebo ještě odlišnou kombinaci růst HDP - růst průměrné mzdy a levnění potravin (rok 2016).
*/